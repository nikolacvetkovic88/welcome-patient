...
GLoc = {
    ...
    geoSuccess: function(position) {
        ...
        g.startPos = position;
        g.searchQuery = 'http://api.openweathermap.org/data/2.5/weather?lat=' + g.startPos.coords.latitude + '&lon=' + g.startPos.coords.longitude + '' + '&APPID=9343ee48fcda037b2627c4b1210da746';
...
WeatherInfo = {
    ...
    getWeatherData: function(searchQuery) {
        if (w.searchLocationInput.val() !== '') {
            w.searchQuery = 'http://api.openweathermap.org/data/2.5/weather?q=' + w.searchLocationInput.val() + '' + '&APPID=9343ee48fcda037b2627c4b1210da746';
